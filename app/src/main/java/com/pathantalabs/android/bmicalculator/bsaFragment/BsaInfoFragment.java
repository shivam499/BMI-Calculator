...
public class BsaInfoFragment extends Fragment{
    private TextView QuestionText;
    private TextView AnswerText;
    public BsaInfoFragment() {
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        QuestionText.setText(Html.fromHtml(getString(R.string.bsa_ques)));
        //noinspection deprecation
        AnswerText.setText(Html.fromHtml(getString(R.string.bsa_ans)));
    }
}
