...
public class BmiInfoFragment extends Fragment{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        QuestionText.setText(Html.fromHtml(getString(R.string.bmi_ques)));
        //noinspection deprecation
        AnswerText.setText(Html.fromHtml(getString(R.string.bmi_ans)));
    }
}
