...
public class BmrInfoFragment extends Fragment{

    private TextView QuestionText;
    private TextView AnswerText;

    public BmrInfoFragment() {
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        QuestionText.setText(Html.fromHtml(getString(R.string.bmr_ques)));
        //noinspection deprecation
        AnswerText.setText(Html.fromHtml(getString(R.string.bmr_ans)));
    }
}
