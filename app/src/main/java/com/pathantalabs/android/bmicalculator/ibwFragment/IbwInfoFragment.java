...
public class IbwInfoFragment extends Fragment{
    private TextView QuestionText;
    private TextView AnswerText;
    public IbwInfoFragment() {
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        QuestionText.setText(Html.fromHtml(getString(R.string.ibw_ques)));
        //noinspection deprecation
        AnswerText.setText(Html.fromHtml(getString(R.string.ibw_ans)));
    }
}
